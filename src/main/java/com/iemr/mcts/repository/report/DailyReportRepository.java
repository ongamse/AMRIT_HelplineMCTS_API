...
public interface DailyReportRepository extends CrudRepository<BenCallDetail, Integer>{
	...
	Integer getTotalCallAnsweredMother(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("callTypeID") Integer callTypeID, @Param("district") String district);
	...
	@Query("SELECT COUNT(DISTINCT benCallDetail.phoneNumber) "
			+ "FROM BenCallDetail benCallDetail "
			+ "inner join benCallDetail.benReport ben "
			+ "where benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.isMother = true and ben.district = :district "
			+ "and benCallDetail.createdDate >= :startDate and benCallDetail.createdDate <= :endDate ")
	...
	Integer getTotalCallMotherByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	Integer getTotalSelfNoCallMotherByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = true ")
	Integer getTotalOtherNoCallMotherByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "where benCallDetail.createdDate >= :startDate and benCallDetail.createdDate <= :endDate and benCallDetail.callTypeID = :callTypeID and ben.district = :district "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = true ")
	Integer getTotalCallAnsweredMotherByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("callTypeID") Integer callTypeID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.isVerified = true and ben.district = :district "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = true ")
	Integer getTotalVerifiedCallMotherByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.isVerified = false and ben.district = :district "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = true ")
	Integer getTotalNotVerifiedCallMotherByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(DISTINCT benCallDetail.phoneNumber) "
			...
			+ "where benCallDetail.createdDate >= :startDate and benCallDetail.createdDate <= :endDate and ben.district = :district "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = true ")
	Integer getTotalUniqueNoCallMotherByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = false ")
	Integer getTotalSelfNoCallChildByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = false ")
	Integer getTotalOtherNoCallChildByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "where benCallDetail.createdDate >= :startDate and benCallDetail.createdDate <= :endDate and benCallDetail.callTypeID = :callTypeID and ben.district = :district "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = false ")
	Integer getTotalCallAnsweredChildByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("callTypeID") Integer callTypeID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.isVerified = true "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = false ")
	Integer getTotalVerifiedCallChildByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.isVerified = false "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = false ")
	Integer getTotalNotVerifiedCallChildByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(DISTINCT benCallDetail.phoneNumber) "
			...
			+ "where benCallDetail.createdDate >= :startDate and benCallDetail.createdDate <= :endDate and ben.district = :district "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID and benCallDetail.isMother = false ")
	Integer getTotalUniqueNoCallChildByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
	...
	@Query("SELECT COUNT(benCallDetail.benCallID) "
			...
			+ "and benCallDetail.isVerified = false "
			+ "and benCallDetail.providerServiceMapID = :providerServiceMapID and benCallDetail.userID = :userID ")
	Integer getTotalNotVerifiedCallByAgentID(@Param("startDate") Timestamp startDate, @Param("endDate") Timestamp endDate,
			@Param("providerServiceMapID") Long providerServiceMapID, @Param("userID") Integer userID, @Param("district") String district);
